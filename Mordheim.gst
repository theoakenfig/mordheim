...
<gameSystem id="9481a749-7900-614b-1695-bdc2899069c1" name="Mordheim" revision="16" battleScribeVersion="2.03" authorName="Uncle Mel" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  ...
  <costTypes>
    ...
    <costType id="rarity" name=" Rarity" defaultCostLimit="-1.0" hidden="true"/>
  </costTypes>
  <profileTypes>
